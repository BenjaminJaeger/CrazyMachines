package RenderEngine.Core.Shaders.Core;
...
import RenderEngine.Core.CatchErrors.CatchGLSLErrors;
...
public abstract class ShaderProgram {
	...
	private void loadShaderFromFile(String shaderFile){	
		...
		try	{
			sc = new Scanner(new File("src/renderengine/core/shaders/"+shaderFile+".glsl"));
