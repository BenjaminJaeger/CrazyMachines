...
////////////////////
	public BoundingRectangle(float x,float y,float width,float height) {
		super(x, y,new Vector2f[] {new Vector2f(width/2, height/2),new Vector2f(width/2, -height/2),new Vector2f(-width/2, -height/2),new Vector2f(-width/2, height/2)},0,0);
		this.width=width;
		this.height=height;	
	}
	
	public BoundingRectangle(float x,float y,float size) {
		super(x, y,new Vector2f[] {new Vector2f(size/2, size/2),new Vector2f(size/2, -size/2),new Vector2f(-size/2, -size/2),new Vector2f(-size/2, size/2)},0,0);
		this.width=size;
		this.height=size;
	}
